...
namespace detail {
    ...
    public:
        ...
        TokenStream( Iterator _it, Iterator _itEnd ) : it( _it ), itEnd( _itEnd ) {
            loadBuffer();
        }
        ...
        auto count() const -> size_t { return static_cast<size_t>(static_cast<std::ptrdiff_t>(m_tokenBuffer.size()) + (itEnd - it)); }
